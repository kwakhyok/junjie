...
<g:else>
    ...
    <!-- Insert a modal dialog for activity (for an open site registering is possible on any page) -->
    <g:render template="/_common/modals/activityDialog"/>

    <h1>Test Only, Default Bottom</h1>
</g:else>
