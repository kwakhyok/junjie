<ul class="nav tab-menu nav-tabs" id="myTab">
    <li class="active" id="projectGantt"><a href="#gantt">甘特图</a></li>
    <li id="projectProcess"><a href="#process">现场图</a></li>
</ul>
...
<r:script>
    ...
    $(function(){
        $("ul#myTab li#projectProcess").click(function(){
             $("div#process1 div.hiddenProcess").removeClass("hiddenProcess");
             $("div#process1 div.gantt").addClass("hiddenProcess");
        });
        $("ul#myTab li#projectGantt").click(function(){
            $("div#process1 div.hiddenProcess").removeClass("hiddenProcess");
            $("div#process1 div.photos").addClass("hiddenProcess");
        });
    });
</r:script>