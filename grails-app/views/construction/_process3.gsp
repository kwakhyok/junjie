...
<div class="container-fluid" style="overflow: scroll;">
    <div class="gantt hiddenProcess" id="GanttChartDIV3"></div>
</div>
        ...
        <div id="this-carousel-id" class="carousel slide">
            <div class="carousel-inner">
                <div class="item active"><!-- class of active since it's the first item -->
                    <img src="${createLinkTo(dir: 'img/pics', file: '31.jpeg')}" width="800" alt=""/>
                ...
                <div class="item">
                    <img src="${createLinkTo(dir: 'img/pics', file: '32.jpeg')}" width="800" alt=""/>
                ...
                <div class="item">
                    <img src="${createLinkTo(dir: 'img/pics', file: '33.jpeg')}" width="800" alt=""/>
...
<r:script>
    ...
    var g = new JSGantt.GanttChart('g', document.getElementById('GanttChartDIV3'), 'day');
    ...
    if (g) {
        ...
        g.AddTaskItem(new JSGantt.TaskItem(1, '采购', '', '', 'ff0000', 'http://help.com', 0, '李四', 0, 1, 0, 1));
        g.AddTaskItem(new JSGantt.TaskItem(11, '意向企业签到', '7/1/2012', '8/2/2012', 'ff00ff', 'http://www.yahoo.com', 1, '梁晶', 100, 0, 1, 1));
        g.AddTaskItem(new JSGantt.TaskItem(12, '登记企业', '', '', '00ff00', '', 0, '梁晶', 40, 1, 1, 1));
        g.AddTaskItem(new JSGantt.TaskItem(121, '登记投标企业', '7/1/2012', '8/4/2012', '00ffff', 'http://www.yahoo.com', 0, '李四 T.', 60, 0, 12, 1));
        g.AddTaskItem(new JSGantt.TaskItem(122, '登记参建企业', '8/21/2012', '8/25/2012', 'ff0000', 'http://help.com', 0, '李四', 60, 0, 12, 1, 121));
        g.AddTaskItem(new JSGantt.TaskItem(123, '等级专家库', '8/21/2012', '9/11/2012 12:00', 'ffff00', 'http://help.com', 0, '李向阳', 60, 0, 12, 1, 121));
        g.AddTaskItem(new JSGantt.TaskItem(124, '登记图纸库', '8/12/2012', '8/23/2012', 'ff0000', 'http://help.com', 0, '黄旭峰', 60, 0, 12, 1, 0, 'This is another caption'));
        g.AddTaskItem(new JSGantt.TaskItem(2, '合同', '8/14/2012', '8/25/2012', 'ffff00', 'http://help.com', 0, '李四', 20, 0, 0, 1, 122));
        g.AddTaskItem(new JSGantt.TaskItem(21, '合同台账', '8/19/2012', '8/29/2012', 'ffff00', 'http://help.com', 0, '李四', 20, 0, 0, 1, 122));
        g.AddTaskItem(new JSGantt.TaskItem(22, '合同付款', '8/24/2012', '8/25/2012', 'ffff00', 'http://help.com', 0, '李四', 20, 0, 0, 1, 122));
        g.AddTaskItem(new JSGantt.TaskItem(3, '设计', '', '', 'ff0000', 'http://help.com', 0, '李四', 0, 1, 0, 1));
        ...
        g.AddTaskItem(new JSGantt.TaskItem(31, '饰装修设计', '7/25/2012', '8/17/2012', 'ff00ff', 'http://help.com', 0, '李四', 30, 0, 3, 1, '', 'Caption 1'));
        ...
        g.AddTaskItem(new JSGantt.TaskItem(332, '高压氧仓设计', '8/6/2012', '8/11/2012', '0000ff', 'http://help.com', 0, '李四', 60, 0, 33, 1));
        g.AddTaskItem(new JSGantt.TaskItem(333, '直线加速器', '8/9/2012', '8/20/2012', '0000ff', 'http://help.com', 0, '李四成', 60, 0, 33, 1));
    ...
    $(function(){
        $("ul#myTab li#projectProcess").click(function(){
            $("div#process3 div.hiddenProcess").removeClass("hiddenProcess");
            $("div#process3 div.gantt").addClass("hiddenProcess");
        });
        $("ul#myTab li#projectGantt").click(function(){
            $("div#process3 div.hiddenProcess").removeClass("hiddenProcess");
            $("div#process3 div.photos").addClass("hiddenProcess");
        });
    });
</r:script>