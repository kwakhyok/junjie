<div class="intentionOrgTableMenu hidden">
    <ul class="nav nav-pills">
        <li><g:remoteLink action="ajaxImportIntentionOrgs" update="[success:'intentionOrgListPanel']"
                          onSuccess="reLoadIntentionOrgDataTable()"  onLoading="showSpinner(true)"
                          onComplete="showSpinner(false)">导入意向企业</g:remoteLink></li>
        <li><a href="#">恢复初始</a></li>
    </ul>
</div>
<img id="spinner" src="${createLinkTo(dir:'images', file:'spinner.gif')}" style="display: none" alt=""/>
