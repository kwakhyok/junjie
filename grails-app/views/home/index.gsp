...
<head>
    ...
    <link rel="stylesheet" href="${createLinkTo(dir: 'css', file: 'fn.gantt.css')}"/>
</head>
...
<body>
	...
	<section id="intro" class="first">
        <g:render template="/templates/gantt"/>
	</section>
...
<script type="text/javascript" src="${createLinkTo(dir: 'js', file: 'jquery.fn.gantt.js')}"></script>
</body>
