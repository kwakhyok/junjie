...
jQuery(document).ready(function (b) {
    ...
    b("#widgets-area-button").click(function () {
        if (b(this).hasClass("open")) {
            ...
            b("#content").removeClass("span11");
            b("#content").addClass("span9");
            ...
            b("#content").removeClass("span9");
            b("#content").addClass("span11")
        }
    });
...
function chart() {
    if ($(".verticalChart")) {
        $(".singleBar").each(function () {
            ...
            $(this).find(".value").animate({height:a}, 2000, function () {
